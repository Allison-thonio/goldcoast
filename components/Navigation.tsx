...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* Fullscreen Mobile Navigation Menu (Rendered outside header to avoid backdrop-filter containing block issues) */}
      {isOpen && (
        <div
          className="fixed inset-0 z-50 bg-teal-ink/95 backdrop-blur-2xl flex flex-col justify-between p-8 md:hidden animate-in fade-in zoom-in-95 duration-300 min-h-[100dvh]"
          role="dialog"
          aria-modal="true"
        ...
        >
          <div className="flex items-center justify-between pt-2">
            ...
            <button
              ...
              className="w-10 h-10 rounded-full bg-teal-ink border border-sand/20 flex items-center justify-center text-sand hover:bg-white/10 transition-colors"
            >
              ✕
            </button>
          </div>
